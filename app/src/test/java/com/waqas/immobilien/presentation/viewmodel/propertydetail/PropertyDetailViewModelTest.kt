...
class PropertyDetailViewModelTest {
    ...
    @Test
    fun `load property successfully should update state with property`() = runTest {
        // Given
        val propertyId = 1
    ...
    @Test
    fun `load property with failure should update state with error`() = runTest {
        // Given
        val propertyId = 1
    ...
    @Test
    fun `load property should set isLoading to true initially and then false on success`() = runTest {
        // Given
        val propertyId = 1
        val mockProperty = Property(
            id = propertyId,
    ...
    @Test
    fun `load property should set isLoading to true initially and then false on failure`() = runTest {
        // Given
        val propertyId = 1
        val errorMessage = "Network error"
        val exception = RuntimeException(errorMessage)
