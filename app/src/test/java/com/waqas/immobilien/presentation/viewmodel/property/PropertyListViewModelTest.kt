...
class PropertyListViewModelTest {
    ...
    @Test
    fun `load properties successfully should update state and show success toast`() = runTest {
        // Given
    ...
    @Test
    fun `load properties with failure should update state and show error toast`() = runTest {
        // Given
    ...
    @Test
    fun `load properties should set isLoading to false even on success`() = runTest {
        // Given
        val mockProperties = listOf(
            Property(
                id = 1,
